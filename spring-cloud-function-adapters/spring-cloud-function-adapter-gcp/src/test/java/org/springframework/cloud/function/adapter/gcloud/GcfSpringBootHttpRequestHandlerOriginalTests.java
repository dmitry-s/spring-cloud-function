 ...
 */
public class GcfSpringBootHttpRequestHandlerOriginalTests {

	HttpRequest request = Mockito.mock(HttpRequest.class);

	private GcfSpringBootHttpRequestHandlerOriginal<?> handler = null;

	public static final Gson GSON = new Gson();

	<O> GcfSpringBootHttpRequestHandlerOriginal<O> handler(Class<?> config) {
		GcfSpringBootHttpRequestHandlerOriginal<O> handler = new GcfSpringBootHttpRequestHandlerOriginal<>(config);
	...
	public void testWithBody() throws Exception {
		GcfSpringBootHttpRequestHandlerOriginal<Foo> handler = handler(FunctionMessageBodyConfig.class);
	...
	public void testWithRequestParameters() throws Exception {
		GcfSpringBootHttpRequestHandlerOriginal<Foo> handler = handler(FunctionMessageEchoReqParametersConfig.class);
	...
	public void testWithEmptyBody() throws Exception {
		GcfSpringBootHttpRequestHandlerOriginal<Foo> handler = handler(FunctionMessageConsumerConfig.class);
	...
	protected static class FunctionMessageBodyConfig {
		...
		public Function<Message<Foo>, Message<Bar>> function() {
			return (foo -> {
				...
				return new GenericMessage<>(new Bar(foo.getPayload().getValue().toUpperCase()), headers);
			});
		}
